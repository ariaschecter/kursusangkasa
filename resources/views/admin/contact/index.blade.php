            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">All Contacts Data</h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($contacts as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.contact.delete', $contact->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
