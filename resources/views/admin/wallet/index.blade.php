                            ...
                            <tbody>
                                ...
                                @foreach ($wallet->wallet_history as $history)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <a href="{{ route('admin.history.edit', $history->id) }}" class="btn btn-info sm" title="Edit Data"><i class="fas fa-edit"></i></a>
                                            <a href="{{ route('admin.history.delete', $payment_method->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete"><i class="fas fa-trash-alt"></i></a> --}}
                                        </td>
                                    </tr>
                                @endforeach
