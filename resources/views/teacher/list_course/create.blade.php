    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Add List Course</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Add List Course</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="col-12">
          <div class="card">
              <div class="card-body">
                ...
                <h4 class="card-title">Add List Course </h4>

                <form method="post" action="{{ route('teacher.list_course.store', $course->course_slug) }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default Select Example" name="sub_course_id" id="sub_course_id">
                                ...
                                @foreach ($course->sub_course as $sub_course)
                                    <option value="{{ $sub_course->id }}" {{ ($sub_course->id == old('sub_course_id') ? 'selected' : '') }}>{{ $sub_course->sub_course_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="list_course_name" class="form-control" type="text" value="{{ old('list_course_name') }}" id="list_course_name">
