              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('teacher.list_course.update', $listcourse->list_course_slug) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="list_course_link" class="form-control" type="text" value="{{ $listcourse->list_course_link }}" id="list_course_link" placeholder="https://www.youtube.com/watch?v=abcdefgh">
