              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.mail.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="subject" class="form-control" type="text" value="" id="subject">
                            @error('subject')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <label for="message" class="col-sm-2 col-form-label">admin Bio</label>
                        <div class="col-sm-10">
                            <textarea name="message" id="elm1" class="form-control" cols="30" rows="10"></textarea>
                            @error('message')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
