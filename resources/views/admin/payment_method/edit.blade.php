      ...
      <div class="col-12">
          <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.payment_method.update', $payment_method->id) }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row mb-3">
                        <label for="payment_method" class="col-sm-2 col-form-label">Payment Method</label>
                        <div class="col-sm-10">
                            <input name="payment_method" class="form-control" type="text" value="{{ $payment_method->payment_method }}" id="payment_method">
                    ...
                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Payment Method Data">
                  </form>
