              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.faq.update', $faq->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="faq_title" class="form-control" type="text" value="{{ $faq->faq_title }}" id="faq_title">
                            @error('faq_title')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="faq_desc" class="form-control" cols="30" rows="10">{{ $faq->faq_desc }}</textarea>
                            @error('faq_desc')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
