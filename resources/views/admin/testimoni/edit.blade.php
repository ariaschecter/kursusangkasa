      ...
      <div class="col-12">
          <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.testimoni.update', $testimoni->id) }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row mb-3">
                        <label for="testimoni_name" class="col-sm-2 col-form-label">Testimoni Name</label>
                        <div class="col-sm-10">
                            <input name="testimoni_name" class="form-control" type="text" value="{{ $testimoni->testimoni_name }}" id="testimoni_name">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="testimoni_feedback" class="form-control" cols="30" rows="10">{{ $testimoni->testimoni_feedback }}</textarea>
                  ...
                  <!-- end row -->
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <img id="showImage" class="img-fluid img-thumbnail" src="{{ asset('storage/' . $testimoni->testimoni_picture) }}" alt="Image Show">
                      </div>
                  </div>
                  <!-- end row -->
                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Testimoni Data">
                  </form>
