...
<div class="page-content">
    <div class="container-fluid">
        ...
        <a href="{{ $wallet->wallet_amount < $setting->min_withdraw ? '#' : route('user.wallet.withdraw') }}" class="btn btn-primary mb-2 col-lg-2">Withdraw</a>
        <p class="btn btn-danger ml-3 mb-2 col-lg-7">Minimum Withdraw : Rp. {{ number_format($setting->min_withdraw) }}</p>
        <a href="{{ route('user.wallet.method') }}" class="btn btn-warning ml-3 mb-2 col-lg-2">Update Wallet Method</a>
